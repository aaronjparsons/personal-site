    ...
    return (
      <div className="container about">
        <div>
          ...
          <p>Currently working with <span className='bold'>Javascript</span>, <span className='bold'>React</span>, <span className='bold'>Express</span>, <span className='bold'>Node.js</span>, <span className='bold'>MongoDB/postgreSQL/Firebase</span>, and <span className='bold'>SASS</span>.</p>
        </div>
      </div>
    );
  }
